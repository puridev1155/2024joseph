                    ...
                    <div class="p-6 relative">
                        <div class="flex h-full items-center justify-center py-5">
                            <div class="text-center max-w-3xl mx-auto relative">
                                <span class="py-1 px-3 rounded-md text-sm font-medium uppercase tracking-wider text-white bg-white/10">Admission</span>
                                <h1 class="md:text-5xl/snug text-3xl font-bold text-white mt-3">입학안내</h1>
            ...
            <div class="relative w-full lg:w-full mx-auto order-1">
                ...
                <div class="group">
                    <div class="w-full group-hover:translate-x-2 group-hover:-translate-y-2 transition-all duration-500">
                        <div class="p-6 bg-orange text-center dark:bg-default-50 {{ $id == NULL ? 'bg-white' :  'bg-orange' }}">
                            
                            <h2 class="text-xl font-medium text-default-950 ">신입생 신청하기</h2>
                ...
                <div class="group">
                    <div class="w-full group-hover:translate-x-2 group-hover:-translate-y-2 transition-all duration-500">
                        <div class="p-6 bg-orange text-center dark:bg-default-50 {{ $id == NULL ? 'bg-orange' :  'bg-white' }}">
                            ...
                            <h2 class="text-xl font-medium text-default-950 ">재학생 신청하기</h2>
